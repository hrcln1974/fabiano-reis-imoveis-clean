// =====================================================================
// Fabiano Reis Imóveis — script público (produção)
...
const API_BASE = '/api';
// produção: valor de fallback. A fonte de verdade é GET /api/corretor
...
// ============= DETALHES DO IMÓVEL =============
// A partir da produção existe página própria com URL amigável e SEO.
